...
# WRITE YOUR SOLUTION BELOW:
CHANGE_OUTPUT_INDEX=$(bitcoin-cli -regtest  decoderawtransaction "$RAW_TX" | jq -r '.vout | to_entries[] | select(.value.scriptPubKey.addresses[0]=="bcrt1qg09ftw43jvlhj4wlwwhkxccjzmda3kdm4y83ht") | .key')
